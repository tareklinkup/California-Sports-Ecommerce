...
class SettingController extends Controller
{
    ...
    public function update(Request $request) {
        ...
        if ($request->hasFile('logo')) {
            ...
            $settings->logo = $this->imageUpload($request, 'logo', 'uploads/settings');
        }
    ...
    public function bannersUpdate(Request $request)
    {
        ...
        if ($request->hasFile('banner_1')) {
            ...
            $settings->banner_1 = $this->imageUpload($request, 'banner_1', 'uploads/banners');
        }
        ...
        if ($request->hasFile('banner_2')) {
            ...
            $settings->banner_2 = $this->imageUpload($request, 'banner_2', 'uploads/banners');
        }
        ...
        if ($request->hasFile('banner_3')) {
            ...
            $settings->banner_3 = $this->imageUpload($request, 'banner_3', 'uploads/banners');
        }
        ...
        if ($request->hasFile('banner_4')) {
            ...
            $settings->banner_4 = $this->imageUpload($request, 'banner_4', 'uploads/banners');
        }
