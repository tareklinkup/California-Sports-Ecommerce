...
@push('css')
<link href="{{ asset('assets/website/css/skdslider.css') }}" rel="stylesheet">
<link rel="stylesheet" href="{{ asset('assets/website/OwlCarousel2-2.3.4/dist/assets/owl.carousel.min.css') }}">
@endpush
                                ...
                                <div class="agile_top_brand_left_grid">
                                    ...
                                    @if ($recent_product->has_discount)
                                        <div class="agile_top_brand_left_grid_pos">
                                            <img src="{{ asset('assets/website/') }}/images/offer.png" alt=" " class="img-responsive" />
                                        </div>
                                    @endif
...
@push('js')
<!-- main slider-banner -->
<script src="{{ asset('assets/website/js/skdslider.min.js') }}"></script>
<script src="{{ asset('assets/website/OwlCarousel2-2.3.4/dist/owl.carousel.min.js') }}"></script>
