...
<div class="header_top"> 
    ...
    <div class="top-side" style="background:#202020;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                        <p style="color:#fff"><strong>Hotline :</strong> {{ optional($_settings)->phone_1 }}</p>
                </div>
                <div class="col-md-6">
    ...
    <div class="logo_products">
        ...
        <div class="w3ls_logo_products_left">
            <h1><a href="{{ route('home') }}" style="color:#030303;">{{ optional($_settings)->shop_name }}</a></h1>
        </div>
